...
foreach (var validator in ProductionDocumentValidators.Create())
    builder.Services.AddSingleton(typeof(IDocumentRuleValidator), validator);
...
builder.Services.AddSingleton<TextCorrectionProcessor>();
