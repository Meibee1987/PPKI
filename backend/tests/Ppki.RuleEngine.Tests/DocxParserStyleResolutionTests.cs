...
public sealed class DocxParserStyleResolutionTests
{
    ...
    public async Task Style_fixture_exposes_defaults_catalog_theme_and_separate_direct_values()
    {
        ...
        Assert.Equal("2.0", parsed.ParserSchemaVersion);
        Assert.Equal("2.0", parsed.ProjectionSchemaVersion);
    ...
    [Fact]
    public async Task All_six_synthetic_fixtures_remain_parseable()
    {
