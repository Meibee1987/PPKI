...
public static class RuleCatalogImporter
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            var implemented = RuleCoverageManifest.ImplementedMappings.TryGetValue(source.RuleId, out var validationKey);
    ...
    internal static int ReconcileImplementedMappings(IEnumerable<RuleDefinition> rules)
    {
        ...
        {
            if (!RuleCoverageManifest.ImplementedMappings.TryGetValue(rule.RuleCode, out var validationKey))
                continue;
